...
export type LessonProgressType = {
  lesson: Types.ObjectId; // Đây là khoá học nào.
  completed: boolean; // Khóa học đã hoàn thành.
  watchedSeconds: number;
  completedAt?: Date; // Ngày học xong khoá học.
};
...
export type HistoryTypeModel = BaseModel & {
  ...
  totalLessons: number;
  percent: number; // Hiển thị thanh tiến độ
  completed: boolean; // Toàn bộ khóa học đã hoàn thành chưa?
  completedAt?: Date;
};
