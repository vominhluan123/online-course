    ...
    <div className="bg-card border text-card-foreground p-4 rounded-2xl border-border">
      ...
      <div className="py-4 text-muted-foreground">
        <div className="flex items-center justify-end">
          <div className="py-1 gap-1 justify-center px-3 flex items-center bg-accent text-accent-foreground">
            <IconStar className="size-4"></IconStar>
            <span>5.0</span>
          </div>
        </div>
        <p className="font-bold text-lg mb-5 text-primary-foreground">
          Khoá học Nextjs
        </p>
        <div className="flex items-center justify-between">
          <span className="text-sm py-1 text-accent-foreground px-3 bg-accent rounded-full">
            30h20p
          </span>
