    ...
    <div className="bg-card border text-card-foreground p-4 rounded-2xl border-border">
      ...
      <div className="py-4 text-muted-foreground">
        <div className="flex items-center justify-end">
          <div className="py-1 gap-1 justify-center px-3 flex items-center bg-accent text-accent-foreground rounded-full">
        ...
        <Link
          href="#"
          className="flex items-center w-full justify-center mt-10 rounded-lg font-semibold font-heading bg-primary text-primary-foreground h-12 text-base"
        >
          Xem chi tiết
        </Link>
      </div>
