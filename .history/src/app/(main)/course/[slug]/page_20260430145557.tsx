  ...
  return (
    <div className="grid grid-cols-[2fr,1fr] gap-10 min-h-screen">
      <div>
        ...
        <h1 className="font-heading font-bold text-primary text-xl mb-5">
          Khoá học photoshop cơ bản
        </h1>
        <h2 className="text-xl text-muted-foreground font-bold mb-2">Mô tả</h2>
        <span className="leading-normal mb-10 text-muted-foreground">
