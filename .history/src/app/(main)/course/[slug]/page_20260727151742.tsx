  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[2fr,1fr] gap-6 lg:gap-10 min-h-screen">
      <div>
        ...
        <div className="aspect-video relative max-w-5xl mt-5 mb-5 bg-card">
          {course.intro_url ? (
            <iframe
      ...
      <div>
        <div className="bg-card text-card-foreground rounded-lg p-5 mt-5 border border-border ring-ring">
