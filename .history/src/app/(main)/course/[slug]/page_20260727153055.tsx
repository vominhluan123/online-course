  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[2fr,1fr] gap-6 lg:gap-10 min-h-screen">
      <div>
        ...
        <div className="aspect-video relative max-w-5xl mt-5 mb-5 overflow-hidden border-transparent">
          {course.intro_url ? (
            <iframe
              src={getEmbedUrl(course.intro_url)}
              className="border-transparent border w-full h-full rounded-lg object-fill"
              allowFullScreen
            />
          ) : course.image ? (
            <Image
