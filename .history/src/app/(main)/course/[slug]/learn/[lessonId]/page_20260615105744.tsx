...
export default async function LearnPage({ params }: Props) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_350px]">
      ...
      {/* Lesson sidebar */}
      <aside className="rounded-xl sticky top-6 h-[calc(100vh-3rem)] border border-border bg-card flex flex-col">
              ...
              <AccordionItem key={lecture._id} value={lecture._id.toString()}>
                ...
                <AccordionContent>
                  <div className="px-2 pb-2">
                    {lecture.lessons?.map((lesson: any) => {
                      ...
                      return (
                        <Link
                          ...
                          className={`
                      mb-1 flex items-center gap-3 rounded-lg p-3 transition-colors
                      ${
                        isActive
                    ...
                    `}
                        >
                          <CirclePlay className="size-5 shrink-0" />
