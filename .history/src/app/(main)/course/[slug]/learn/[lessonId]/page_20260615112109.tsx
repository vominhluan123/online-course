...
export default async function LearnPage({ params }: Props) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_350px]">
      ...
      {/* Lesson sidebar */}
      <aside className="sticky top-6 flex h-auto max-h-[70vh] flex-col overflow-hidden rounded-xl border border-border bg-card lg:h-[calc(100vh-3rem)] lg:max-h-none mb-5">
        <Progress value={33} />
