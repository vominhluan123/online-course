...
const Page = async () => {
  ...
  return (
    <section className="py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold">Khu vực học tập</h1>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3 ">
        {histories.map((history: any) => (
          <Card
            key={history._id}
            className="overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg border border-border"
          >
            <Image
