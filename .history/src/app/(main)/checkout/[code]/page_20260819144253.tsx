...
const CheckOut = async ({ params }: { params: Promise<{ code: string }> }) => {
  ...
  return (
    <div>
      ...
      chuyển khoản là <div>{checkoutDetails.code}</div> Số tài khoản
      105003175318 Tên tài khoản Nguyen Tran Thao Nguyen Ngân hàng Ngân hàng
      Vietin Bank Số tiền cần thanh toán 499.000 VNĐ Nếu bạn cần hỗ trợ, vui
      lòng liên hệ Admin qua fb cá nhân: Evondev
    </div>
  );
};
