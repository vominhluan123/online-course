...
const CheckOut = async ({ params }: { params: Promise<{ code: string }> }) => {
  ...
  return (
    <div>
      ...
      105003175318 Tên tài khoản Vo Minh Luan Ngân hàng Ngân hàng Vietin Bank Số
      tiền cần thanh toán 499.000 VNĐ Nếu bạn cần hỗ trợ, vui lòng liên hệ Admin
      qua fb cá nhân: LuanMinh
    </div>
  );
};
