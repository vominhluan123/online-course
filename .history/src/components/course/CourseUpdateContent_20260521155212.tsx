                    ...
                    {editingLectureId === lecture._id.toString() ? (
                      <>
                        ...
                        <button
                          ...
                          className="disabled:pointer-events-none disabled:hover:op flex size-8 cursor-pointer items-center justify-center rounded-md transition-colors hover:bg-muted"
                          onClick={() =>
