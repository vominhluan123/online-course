                    ...
                    {editingLectureId === lecture._id.toString() ? (
                      <>
                        ...
                        <div
                          ...
                          className={`flex size-8 items-center justify-center rounded-md transition-colors${isDisabledSave || loading ? "disabled:cursor-not-allowed disabled:opacity-50" : "cursor-pointer hover:bg-muted"}`}
                          onClick={() => {
