...
const CourseUpdateContent = ({
  ...
  const [deleteLesson, setDeleteLoading] = useState(false);
  ...
  const handleStartEditLesson = (lesson: LessonTypeModel) => {
    setEditingLessonId(lesson._id.toString());
  ...
  return (
    <>
                ...
                <div className="border-t border-border bg-muted/20">
                  ...
                  <div className="p-4">
                    ...
                    >
                      ...
                      {lessonLoading ? "Đang thêm..." : "Thêm bài học"}
                    </Button>
                  </div>
                </div>
              </AccordionContent>
      ...
      >
        {createLoading ? "Đang thêm..." : "Thêm chương mới"}
      </Button>
    </>
  );
};
