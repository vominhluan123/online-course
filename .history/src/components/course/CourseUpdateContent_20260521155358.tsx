                    ...
                    {editingLectureId === lecture._id.toString() ? (
                      <>
                        ...
                        <button
                          ...
                          className="disabled:cursor-not-allowed disabled:hover:bg-none flex size-8 cursor-pointer items-center justify-center rounded-md transition-colors hover:bg-muted"
                          onClick={() =>
