...
const imageUrl = form.watch("image"); // ← thêm dòng này
const [imageUrl, setImageUrl] = useState<string>(""); // ← thêm dòng này

// Đồng bộ imageUrl từ form khi component mount
useEffect(() => {
            ...
            {imageUrl ? (
              ...
              <div className="mt-3 space-y-3">
                ...
                <Button
                  ...
                  onClick={() => {
                    setImageUrl(""); // xóa ảnh
                    form.setValue("image", undefined); // đồng bộ với form
                  }}
                >
                  Xóa ảnh
                </Button>
