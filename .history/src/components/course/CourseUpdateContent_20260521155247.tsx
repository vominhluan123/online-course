                    ...
                    {editingLectureId === lecture._id.toString() ? (
                      <>
                        ...
                        <button
                          ...
                          className="disabled:pointer-events- disabled:hover:opacity-50 flex size-8 cursor-pointer items-center justify-center rounded-md transition-colors hover:bg-muted"
                          onClick={() =>
