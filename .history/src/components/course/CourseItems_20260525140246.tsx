  ...
  return (
    <article className="bg-card border text-card-foreground p-3 md:p-4 rounded-xl border-border flex flex-col h-full">
      ...
      <div className="pt-4 flex flex-col flex-1 min-w-0">
        ...
        <Link
          href={`/course/${course.slug}`}
          className="flex items-center w-full justify-center md:mt-10 mt-6 rounded-lg font-semibold font-heading bg-primary text-primary-foreground h-10 md:h-12 hover:bg-primary/80"
        >
          Xem chi tiết
        </Link>
      </div>
