...
const formSchema = z
  .object({
    ...
    maxUses: z.coerce
      .number({
        required_error: "Vui lòng nhập số lượng", // Báo lỗi khi không nhập gì (để trống)
        invalid_type_error: "Số lượng tối đa phải là số", // Báo lỗi khi nhập chữ/ký tự không hợp lệ
      })
