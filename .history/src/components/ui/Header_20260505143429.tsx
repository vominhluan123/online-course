...
const Header = ({ onMenuClick }: { onMenuClick?: () => void }) => {
  ...
  return (
    <header
      className={`text-card-foreground border-border duration-300 transition-all ${
        isScrolled ? "bg-card/80 backdrop-blur-md shadow-md" : "bg-white/30backdrop-blur-md bg-white/30
