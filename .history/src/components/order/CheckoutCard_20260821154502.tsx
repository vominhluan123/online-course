...
import { CircleCheckBig, Copy, Check } from "lucide-react";
      ...
      <div className="rounded-2xl border bg-background shadow-sm p-8 space-y-6">
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <h1 className="text-3xl font-bold">
            {checkoutDetails.status === OrderStatus.PENDING && (
              <h1>Đặt hàng thành công!</h1>
            )}

            {checkoutDetails.status === OrderStatus.PAID && (
              <h1>Thanh toán thành công!</h1>
            )}

            {checkoutDetails.status === OrderStatus. && (
