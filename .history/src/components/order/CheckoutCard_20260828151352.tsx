...
import { Check, CircleCheckBig, CircleX, Clock3, Copy } from "lucide-react";
      ...
      case OrderStatus.PENDING:
        return (
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-900/30">
            <Clock3 className="h-9 w-9 text-yellow-600" />
          </div>
        );
      ...
      case OrderStatus.PAID:
        return (
          <div className="space-y-3">
            ...
            <Button className="font-heading px-6 py-3 bg-black text-white rounded-lg">
              <Link href="/">Bắt đầu học</Link>
            </Button>
          </div>
        );
      ...
      case OrderStatus.CANCELLED:
        return (
          <div className="space-y-3">
            ...
            <p className="text-base font-normal text-muted-foreground">
              Nếu bạn cho rằng đây là nhầm lẫn, vui lòng liên hệ Admin để được
              hỗ trợ.
            </p>
