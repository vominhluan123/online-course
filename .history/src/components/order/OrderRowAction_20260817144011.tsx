import { approveOrder } from "@/actions/order/approve-order";
import { cancelOrder } from "@/actions/order/cancel-order";
import { OrderStatus, OrderTableType } from "@/types/order";
import { CheckCheck, CircleX, MoreHorizontal } from "lucide-react";
...
const OrderRowAction = ({ order }: Props) => {
  ...
  // Chỉ đơn hàng đang chờ thanh toán
  // mới được phép thực hiện hành động.
